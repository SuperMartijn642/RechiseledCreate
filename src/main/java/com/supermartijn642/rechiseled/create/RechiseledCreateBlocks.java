...
public class RechiseledCreateBlocks {
    ...
    // Mangrove window
    private static final Supplier<BlockProperties> MANGROVE_WINDOW_BLOCK_PROPERTIES = () -> BlockProperties.create(Material.WOOD, MaterialColor.COLOR_RED).strength(0.3F).sound(SoundType.GLASS).noOcclusion().isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never);
