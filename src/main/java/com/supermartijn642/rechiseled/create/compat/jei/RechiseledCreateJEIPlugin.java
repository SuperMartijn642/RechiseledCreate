...
public class RechiseledCreateJEIPlugin implements IModPlugin {
    ...
    public ResourceLocation getPluginUid(){
        return ResourceLocation.fromNamespaceAndPath(RechiseledCreate.MODID, "chiseling_plugin");
    }

    @Override
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration){
        registration.addRecipeCatalyst(RechiseledCreate.mechanical_chisel, ChiselingJEIPlugin.CHISELING_RECIPE_TYPE);
    }
}
